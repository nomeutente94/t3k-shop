...
<%	ArrayList<String> currentWishlist = (ArrayList<String>)session.getAttribute("wishlist"); 
 	if(currentWishlist==null)
 		currentWishlist = new ArrayList<String>();
			...
			<div id="centralblock">
				...
				<aside id="centrale">
					<section id="internalsection">
						<br>
						<% for(int i=0; i<wishlistToDisplay.size(); i++){ %>
							<%=wishlistToDisplay.get(i).getNome()%><br>
							<form action="removeWishlist" method="post">
								<input type="hidden" name="id" value="<%=wishlistToDisplay.get(i).getId()%>">
